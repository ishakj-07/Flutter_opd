...
class _MyWidgetState extends State<MyWidget> {
  ...
  TextEditingController _dobDateController = TextEditingController();
  ...
  TextEditingController _scheduletimeController = TextEditingController();
            ...
            children: [
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(
                    color: const Color.fromARGB(
                        255, 120, 117, 117), // Color of label
                    fontSize: 13,
                  ...
                  if (pickedTime != null) {
                    setState(() {
                      _timeController.text = pickedTime
                          .format(context); // 12-hour format with AM/PM
                    });
                  }
                },
              ),
              ...
              DropdownButtonFormField<String>(
                ...
                onChanged: (String? newValue) {
                  setState(() {
                    // store the selected doctor value if needed
                  });
                },
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Dr. Sharma', 'Dr. Verma', 'Dr. Kapoor']
                    .map((doctor) => DropdownMenuItem(
                          value: doctor,
                          child: Center(
                              child: Text(doctor)), // Center selected items
                        ))
                    .toList(),
                decoration: InputDecoration(
                  border: UnderlineInputBorder(),
          ...
          builder: (context, setState) {
            return AlertDialog(
              ...
              content: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Consulting Doctor: $consultingDoctor",
                      style:
                          TextStyle(fontSize: 12, fontWeight: FontWeight.w400)),
                  SizedBox(height: 8),
                  Text("Patient Name: $nameOfPatient",
                      style:
                          TextStyle(fontSize: 12, fontWeight: FontWeight.w400)),
                  SizedBox(height: 30),
